...
import { selectAllTeams, selectTeam, selectTeamMembers } from "@/store/slices/teamsSlice";
            ...
            >
                ...
                >
                    ...
                    <View>
                        ...
                        >
                            {(towns[item.team.townId as string] || {} as any).name || ""}
                        </Text>
                    </View>
                </View>
                <View>
            ...
            {hasTeams ? (
                ...
                <View style={styles.noTeamsFound}>
                    <View style={styles.noTeamsFoundWrapper}>
                        ...
                        <DisplayText
                            style={{ ...styles.noTeamsFoundText, marginTop: 10 }}
                        >
