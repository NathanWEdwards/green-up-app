        ...
        <View style={styles.frame}>
            <ScrollView style={styles.scroll}>
                <View style={styles.infoBlockContainer}>
                    <View style={styles.infoBlockHeader}>
                        ...
                        <Text style={styles.headerText}>
                            {moment(
                                isValidDate(eventDate) ? eventDate : getCurrentGreenUpDay()
                            )
                                .utc()
                ...
                <View style={styles.infoBlockContainer}>
                    ...
                    >
                        I didn't really think about the environment until it actually
                        impacted me.{"\n"}
                        I was driving to the city with my dad when I noticed the amount
                        of trash on the side of the road{"\n"}
                        The city smelt, the ground was dirty, and it was because no one
                        was taking care of the environment.{"\n"}
                        ...
                        {"\n"}
                        If we don't take care of our environment, our children will have
                        to do it.{"\n"}
                        By then, it'll be way worse.{"\n"}
                        Global warming, littering, and pollution are serious problems.
                        {"\n"}
                        Even just picking up your trash and sorting it into recycling is
                        helping.{"\n"}
                        It's the little actions that matter, they're small, but mighty.
                        {"\n"}
                        As my mom used to say, "If everyone chips in, it'll make the
                        work easier and faster."{"\n"}
                        Our global issues might not go away overnight, but if we start
                        now, it'll go away faster.{"\n"}
                    </Text>
                </View>
                ...
                <View style={styles.infoBlockContainer}>
                    ...
                    >
                        50 years of greening up and we're still going strong! The reason
                        Vermonters celebrate Green Up Day is so we can help our
                        community. I feel this event is really important because it makes
                        the environment a better place. Without all that trash around it
                        is much safer, much cleaner, and most of all prettier.
                    </Text>
                    <Text
                        style={{
                            textAlign: "left",
                    ...
                    >
                        We are called the Green Mountain State for a reason. We have some
                        of the most amazing scenery in the country. The greenery we are
                        famous for gets hidden when our roadways are littered with trash.
                        It's sad. That's why it's important for everyone to pitch in every
                        year on the first Saturday in May so we can live up to our name.
                    </Text>
                    <Text
                        style={{
                            textAlign: "left",
                    ...
                    >
                        Another reason to take part in Green Up Day is that it shows how
                        people can do things locally to contribute to saving the planet.
                        Cleaning up trash keeps toxins out of our waterways and improves
                    ...
                    >
                        On the next Green Up Day gather your friends and volunteer to
                        clean your local community. You can have fun while helping keep
                        our state beautiful. Plus, if someone sees you doing it they may
                ...
                <View style={styles.infoBlockContainer}>
                    ...
                    <View style={styles.infoBlock}>
                        ...
                        <Text style={[styles.textDark, { fontSize: 16 }]}>
                            Phone:{" "}
                            <Anchor
                                style={[
                                    styles.textDark,
