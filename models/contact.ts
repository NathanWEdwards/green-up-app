        ...
        case Array.isArray(phoneNumbers):
            return (
                phoneNumbers
                    ...
                    .map((phoneNumber: any): string => phoneNumber.number)[0] ||
                undefined
            );
...
export default class Contact {
    ...
    constructor(args: any) {
        ...
        this.firstName =
            typeof args.firstName === 'string' ? args.firstName : null;
        this.lastName =
            typeof args.lastName === 'string' ? args.lastName : null;
        this.email = getEmail(args.email || args.emails);
        this.phoneNumber = getPhoneNumber(
            args.phoneNumber || args.phoneNumbers || args.phone
        );
        this.isSelected =
            typeof args.isSelected === 'boolean' ? args.isSelected : false;
    }
