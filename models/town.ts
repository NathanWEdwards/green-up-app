...
export class TownLocation {
    ...
    static create(args?: any, id?: string): TownLocation {
        const _args = { ...args };
        if (Boolean(id)) {
            _args.id = id;
        }
...
export default class Town {
    ...
    constructor(args: any) {
        ...
        this.roadsideDropOffAllowed =
            typeof args.roadsideDropOffAllowed === 'boolean'
                ? args.roadsideDropOffAllowed
                : false;
    ...
    static create(args?: any, id?: string): Town {
        const _args = { ...args };
        if (Boolean(id)) {
            _args.id = id;
        }
