...
export const TownDisposalDetails: React.FC<TownDisposalDetailsProps> = ({
    town,
    closeModal
}) => (
        ...
        <ScrollView style={styles.scroll}>
            ...
            {Boolean(town.pickupInstructions) && (
                ...
                >
                    ...
                    <Text style={{ color: 'black', marginLeft: 20 }}>
                        {town.pickupInstructions}
                    </Text>
                </View>
            )}
            <View
                style={{ padding: 10, backgroundColor: 'white', marginTop: 5 }}
            >
                ...
                >
                    ...
                    >
                        {!town.allowsRoadside && (
                            <FontAwesome
                                style={{ color: '#AAA', position: 'absolute' }}
                                size={65}
                                name={'ban'}
                            />
                        )}
                    ...
                    <View style={{ flexGrow: 1, flexShrink: 1, marginLeft: 5 }}>
                        <View style={{ flex: 1 }}>
                            <Text style={{ fontSize: 19 }}>
                                {town.allowsRoadside
                                    ? 'You may drop your bags along the roadside.'
                                    : 'Roadside drop-off is not allowed. Please take your trash to the nearest collection site.'}
                            </Text>
                        </View>
                    </View>
                </View>
            ...
            {(town.collectionSites || []).length > 0 ? (
                <Fragment>
                    ...
                    >
                        ...
                        >
                            {
                                'Please drop trash off at one of the following locations:'
                            }
                        </Text>
                    </View>
                    {(town.collectionSites || []).map((site) => (
                        ...
                        >
                            <Subtitle
                                style={{ textAlign: 'left', color: '#222' }}
                            >
                                {site.name}
                            </Subtitle>
                            ...
                            >
                                {Address.toString(site.address as any)}
                            </Subtitle>
                            {Boolean(
                                    ...
                                    pinsConfig={[
                                        {
                                            ...
                                            coordinates: site.coordinates as {
                                                latitude: number;
                                                longitude: number;
                                            }
                                        }
