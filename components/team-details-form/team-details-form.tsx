...
const freshState = (owner: User, team?: Team, initialMapLocation?: Coordinates): any => ({
...
export const TeamDetailsForm = ({ currentUser, children, otherCleanAreas, team, onSave }: PropsType) => {
    ...
    const setTeamValue = (key: string): ((a: any) => void) => (value: any) => {
        dispatch({
            type: "SET_TEAM_STATE",
            data: { [key]: value }
        });
                        ...
                        < View style={styles.formControl} >
                            ...
                            < View style={{ flex: 1, flexDirection: 'row' }}>
                                <Pressable
                                    ...
                                    />
                                    < Text style={state.team.isPublic ? { color: "black" } : { color: "white" }} >
                                        PUBLIC
                                    </Text>
                                </Pressable>
                                < Pressable
                                    ...
                                    <MaterialCommunityIcons
                                        ...
                                        color={state.team.isPublic ? "#555" : "black"}
                                    />
                                    <Text style={state.team.isPublic ? { color: "white" } : { color: "black" }}>
                                        PRIVATE
                                    </Text>
                                </Pressable>
                            </View>
