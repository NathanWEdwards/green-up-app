...
const freshState = (
    owner: User,
    team?: Team,
    initialMapLocation?: Coordinates
): any => ({
    ...
    startdate: null,
    initialMapLocation: initialMapLocation || null
});
...
export const TeamDetailsForm = ({
    ...
    const removeLastMarker = () => {
        const locations = state.team.locations.slice(
            0,
            state.team.locations.length - 1
        );
    ...
    const handleStartDatePicked = (event: Event, date: Date) => {
        if ((event as any).type == 'set') {
            console.log('Time Set');
            let newstart = date.toLocaleTimeString('en-GB');
            let start = null;
    ...
    const handleEndDatePicked = (event: Event, date: Date) => {
        if ((event as any).type == 'set') {
            console.log('Time Set');
            let newend = date.toLocaleTimeString('en-GB');
            let end = null;
            console.log('Platform', Platform.OS);
            if (Platform.OS === 'android') {
    ...
    const defaultStartTime = setTime(
        eventDate,
        state.team.startdate || '09:00'
    );
                ...
                <View style={{ flex: 1, justifyContent: 'flex-end' }}>
                    ...
                    >
                        ...
                        <View style={styles.formControl}>
                            ...
                            />
                            <PrimaryButton onPress={removeLastMarker}>
                        ...
                        <View style={styles.formControl}>
                            <Text style={styles.label}>
                                {' '}
                                {'When will your team be cleaning?'}{' '}
                            </Text>
                            <View>
                                <Text style={styles.label}>
                                    {' '}
                        ...
                        <View style={styles.formControl}>
                            ...
                            <View>
                                <TextInput
                                    ...
                                    placeholder={
                                        'Start Time for your pickup event'
                                    }
                                    placeholderTextColor={
                                        colors.placeholderText
                                    }
                        ...
                        <View style={styles.formControl}>
                            ...
                            <View>
                                <TextInput
                                    ...
                                    placeholder={
                                        'End Time for your pickup event'
                                    }
                                    placeholderTextColor={
                                        colors.placeholderText
                                    }
